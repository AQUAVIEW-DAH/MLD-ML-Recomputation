...
- **ERDDAP glider same-day RTOFS run launched in tmux**: Started `tmux` session `mld_erddap_glider` running `build_erddap_glider_rtofs_2024_2025.py --max-datasets 0 --max-rtofs-dates 40`; log path is `ML_baseline/erddap_glider_rtofs_2024_2025_tmux.log`.
